...
namespace ParcelTrackerApp
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            // Register your dependencies, including IParcelService
            container.RegisterType<IParcelTrackerService, ParcelTrackerService>();
            container.RegisterType<IParcelTrackerRepository, ParcelTrackerRepository>();
